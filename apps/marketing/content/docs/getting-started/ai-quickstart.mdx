---
title: AI compatibility quickstart
...
<Cards>
  <Card title="Sessions and budgets" href="/docs/core-concepts/sessions-and-budgets">
    Understand reservation, session state, and the budget boundary.
  </Card>
  <Card title="OpenAI-compatible wrapping" href="/docs/core-concepts/openai-wrapping">
    Understand provider identity, estimation, policy checks, spans, and usage reconciliation.
  </Card>
  <Card title="Tool guardrails" href="/docs/core-concepts/tool-guardrails">
